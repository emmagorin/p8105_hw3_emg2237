...
**The NY NOAA dataset includes weather `r nrow(ny_noaa)` rows of data, one per date per weather station. These data include several weather related metrics, including measures of precipitation, snowfall, snow depth, and temperature. Missingness is a potential issue, especially for ther temperature variables, which are missing for about 44% of the observations.**
...
**Please note for the following questions: my computer took too long to run these for me to effectively check my work. These are my best shot, and I think they should work, but I hope that we'll be able to work with smaller datasets for future assignments...**
