...
**There are 134 aisles. Most items are ordered from the `r most_pop_aisles.df[1,1]` aisle with `r most_pop_aisles.df[1,2]` items ordered, closely followed by `r most_pop_aisles.df[2,1]` aisle with `r most_pop_aisles.df[2,2]` items ordered. Distant 3rd, 4th and 5th places are held by `r most_pop_aisles.df[3,1]`, `r most_pop_aisles.df[4,1]`, and `r most_pop_aisles.df[5,1]`.**
